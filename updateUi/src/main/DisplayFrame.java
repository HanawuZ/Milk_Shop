...
public class DisplayFrame extends javax.swing.JFrame {
    ...
    public DisplayFrame() {
        ...
        try {
            ...
            // ประกาศตัวแปร string ชื่อ queryString สำหรับเก็บคำสั่ง SPARQL query
            ...
            // เรียกใช้เมธอด ExeSparQl โดยส่งตัวแปร queryString เข้าไป เพื่อให้ได้ผลลัพธ์การ query ข้อมูลจากไฟล์ .owl
            org.apache.jena.query.ResultSet results = OpenOWL.ExecSparQl(queryString); // all method ExecSparQl from

            // วนลูป while ถ้าผลลัพธ์มีค่ามากกว่า 1 ค่า??
            while (results.hasNext()) {

                QuerySolution soln = results.nextSolution();

                // ตัวแปร string สำหรับเก็บผลลัพธ์ของ Component ปัจจุบัน(ดึงชื่อคลาสออกมา??)
                String Component = soln.getLiteral("Component").getString();
                // test --

                // แสดงชื่อคลาสใน ontology
                System.out.println("Computer " + Component.toString());

                // เพิ่มชื่อคลาสที่ได้มาเข้าไปในอาเรย์ ListComponent
                ListComponent.add(Component.toString());
                
                // ดึงชื่อ Property จาก ontology??
                RDFNode x = soln.get("Propertyval");

                // นำชื่อ Property มานำเสนอเป็นสตริง ใส่เข้าไปในตัวแปร xx
            ...
            // ลบข้อมูลในอาเรย์ ComponentList ทั้งหมดออก
            ComponentList.removeAllItems(); // combobox nameList

            // วนลูป นำข้อมูลใน ListComponent ไปใส่ไว้ในอาเรย์ ComponentList เพื่อนำไปแสดงใน combobox
    ...
    private void initComponents() {
        ...
        // ประกาศ component ที่ใช้ใน UI
        
        jPanel2 = new javax.swing.JPanel();                     // panel
        jButton2 = new javax.swing.JButton();                   // button
        jScrollPane1 = new javax.swing.JScrollPane();           // scroll panel
        TableComputer = new javax.swing.JTable();               // table ตารางสำหรับแสดงข้อมูล
        NameList = new javax.swing.JComboBox<>();               // combobox สำหรับแสดงชื่อ
        ComponentList = new javax.swing.JComboBox<>();          // combobox สำหรับแสดงชื่อ Component ใน ontology
        jLabel1 = new javax.swing.JLabel();                     // label 
        jLabel2 = new javax.swing.JLabel();                     // label
        jSeparator1 = new javax.swing.JSeparator();             // seperator (divider) สำหรับเป็นเส้นแบ่ง
        KeywordField = new javax.swing.JTextField();            // Textfield สำหรับพิมพ์ keyword
        jButton1 = new javax.swing.JButton();                   // ปุ่มกดสำหรับกดค้นหาข้อมูล
        jLabel3 = new javax.swing.JLabel();                     // label

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);

        // เซ็ตชื่อ tab ของ UI ว่า "Semantic Search: Computer"
        setTitle("Semantic Search: Computer");

        // เซ็ตประเภทฟ้อนเป็น Tahoma ขนาด 18
        jButton2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N

        // เซ็ตคำว่า "Search" เข้าในปุ่ม jButton2 
                                        ...
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                ...
                                                .addGroup(jPanel2Layout
                                                        ...
                                                        .addComponent(jScrollPane1,
                                                                javax.swing.GroupLayout.DEFAULT_SIZE, 854,
                                                                Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
        ...
        queryString = "PREFIX ex:<http://localhost/computer#> "
                ...
                + " }";
        System.out.println(queryString);
        org.apache.jena.query.ResultSet results = OpenOWL.ExecSparQl(queryString); // all method ExecSparQl from OpenOWL
                                                                                   // class
